                ...
                <CardContent className="p-6">
                  <div className="grid grid-cols-12 gap-4 items-center mb-4">
                    ...
                    <div className="col-span-3 text-center">
                      <p className="text-xs text-[#3D4E64] mb-1">Principal</p>
                      <p className="font-bold text-[#213753] text-sm">{formatCurrency(formData.depositAmount)}</p>
                    </div>
                    ...
                    <div className="col-span-3 text-center">
                      <p className="text-xs text-[#3D4E64] mb-1">Payout</p>
                      <div className="flex items-center justify-center gap-1">
                        <Award className="h-3 w-3 text-[#3B9560]" />
                        <p className="font-bold text-[#213753] text-sm capitalize">{formData.interestPayout}</p>
                      </div>
                    </div>
                  </div>
        ...
        <Card className="border border-[#3D4E64]/20 hover:shadow-lg transition-all duration-300 bg-[#FCF9F8]">
          ...
          <CardContent className="space-y-6 pt-6">
            ...
            <div className="space-y-2">
              ...
              >
                <SelectTrigger className="border-[#3D4E64]/30 focus:border-[#3B9560] bg-white">
                  <SelectValue />
                </SelectTrigger>
